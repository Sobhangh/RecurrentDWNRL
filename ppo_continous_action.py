...
import popgym
from popgym.wrappers import PreviousAction, Antialias
...
class WNNActor(nn.Module):
    def __init__(self, env, args):
        ...
        self.actor_mean = RNNDWN(input_dim=obs_dim, 
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        agent.actor_mean.reset_hidden_state(batch_size=args.num_envs, device=device, dtype=torch.float32)
